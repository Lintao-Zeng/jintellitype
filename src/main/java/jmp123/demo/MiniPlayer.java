 ...
 * <ol>
 * <li>是 {@link AbstractDecoder AbstractDecoder} 的子类。</li>
 * <li>创建输入流之后初始化解码器。 {@link #open(String) open} 方法内先创建输入流，再调用父类的
 * {@link AbstractDecoder#openDecoder() openDecoder} 方法初始化解码器。</li>
 * <li>重载 {@link AbstractDecoder#fillBuffer(byte[], int, int) fillBuffer}
 * 方法，使解码器能够从输入流获取数据。</li>
 * <li>重载 {@link AbstractDecoder#done() done} 方法，解码结束时作必要的清理，例如关闭输入流等。</li>
 * </ol>
 * <p>
 * @version 0.400
 */
